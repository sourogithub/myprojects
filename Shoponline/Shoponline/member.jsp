...
<form method="post" action="Memdelete">
insert the userid you want to delete:<input type="text" name="adminuser"/>
<input type="submit" value="delete"/>
</form>
<form method="post" action="deletedmem.jsp">

<input type="submit" value="deleted member"/>
</form>
<% 
...
ResultSet rs= st.executeQuery("select * from member where status=1");
...
out.println("<th><h6>Login Status </h6></th>");
