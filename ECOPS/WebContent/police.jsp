...
ResultSet rs= st.executeQuery("select * from POLICE where COPID='"+user+"'");

while(rs.next())
{%>
<h2>copid:  <%out.println(""+rs.getString(1));%></h2>
...
<h2>email:  <%out.println(""+rs.getString(6));%></h2>
<h2>mobileno:  <%out.println(""+rs.getString(7));%></h2>
<h2>country:  <%out.println(""+rs.getString(8));%></h2>
<h2>state:  <%out.println(""+rs.getString(9));%></h2>
<h2>city:  <%out.println(""+rs.getString(10));%></h2>
<h2>D.O.B:  <%out.println(""+rs.getString(11));%></h2>
<h2>policestation:  <%out.println(""+rs.getString(12));%></h2>
<h2>pincode:  <%out.println(""+rs.getString(13));%></h2>
<h2>sex:  <%out.println(""+rs.getString(14));%></h2>
<%}
con.close();
}
catch(Exception e)
