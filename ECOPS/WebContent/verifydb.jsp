...
String email = request.getParameter("email");
 try
    ...
    int i=st.executeUpdate("select * from PUBLICUSER where USERID='"+user+"' and Email='"+email+"'");
    if(i>0){ 
    	...
    	<div align="center">
    	<h2>Invalid userid and email.</h2>
    	<h2>verification Failed!<a href='Front.jsp'>Go to login</a></h2>
