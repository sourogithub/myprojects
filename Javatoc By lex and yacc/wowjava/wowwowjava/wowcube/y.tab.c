...
{
  "$end", "error", "$undefined", "p", "$accept", "c", YY_NULLPTR
};
#endif
...
#line 25 "yaccmain.y" /* yacc.c:1646  */
   ...
   char* id; 
   n->id = malloc(sizeof(char)*(strlen((yyvsp[0].strval))+1)); 
   strcpy(n->id,(yyvsp[0].strval));
   c = n;
   }
...
#line 33 "yaccmain.y" /* yacc.c:1906  */
