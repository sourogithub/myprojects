...
def RFclassifier_for_co2(data_train,data_test,train_rows,test_rows):
...
RFclassifier_for_co2(data_train1,data_test1,len(data_train1),len(data_test1))
...
RFclassifier_for_co2(data_train2,data_test2,len(data_train2),len(data_test2))
...
RFclassifier_for_co2(data_train3,data_test3,len(data_train3),len(data_test3))
...
RFclassifier_for_co2(data_train4,data_test4,len(data_train4),len(data_test4))
...
RFclassifier_for_co2(data_train5,data_test5,len(data_train5),len(data_test5))
...
RFclassifier_for_co2(data_train6,data_test6,len(data_train6),len(data_test6))
...
RFclassifier_for_co2(data_train7,data_test7,len(data_train7),len(data_test7))
...
RFclassifier_for_co2(data_train8,data_test8,len(data_train8),len(data_test8))
...
RFclassifier_for_co2(data_train9,data_test9,len(data_train9),len(data_test9))
...
RFclassifier_for_co2(data_train10,data_test10,len(data_train10),len(data_test10))
...
RFclassifier_for_co2(data_train11,data_test11,len(data_train11),len(data_test11))
...
RFclassifier_for_co2(data_train12,data_test12,len(data_train12),len(data_test12))
...
RFclassifier_for_co2(data_train13,data_test13,len(data_train13),len(data_test13))
...
RFclassifier_for_co2(data_train14,data_test14,len(data_train14),len(data_test14))
...
RFclassifier_for_co2(data_train15,data_test15,len(data_train15),len(data_test15))
...
def RFclassifier_for_co(data_train,data_test,train_rows,test_rows):
 Data_train = data_train.drop(0,axis=1)
 Data_train1 = Data_train.drop(1,axis=1)
 Target_train = Data_train[1]
 Data_test = data_test.drop(0,axis=1)
...
RFclassifier_for_co(data_train1,data_test1,len(data_train1),len(data_test1))
...
RFclassifier_for_co(data_train2,data_test2,len(data_train2),len(data_test2))
...
RFclassifier_for_co(data_train3,data_test3,len(data_train3),len(data_test3))
...
RFclassifier_for_co(data_train4,data_test4,len(data_train4),len(data_test4))
...
RFclassifier_for_co(data_train5,data_test5,len(data_train5),len(data_test5))
...
RFclassifier_for_co(data_train6,data_test6,len(data_train6),len(data_test6))
...
RFclassifier_for_co(data_train7,data_test7,len(data_train7),len(data_test7))
...
RFclassifier_for_co(data_train8,data_test8,len(data_train8),len(data_test8))
...
RFclassifier_for_co(data_train9,data_test9,len(data_train9),len(data_test9))
...
RFclassifier_for_co(data_train10,data_test10,len(data_train10),len(data_test10))
...
RFclassifier_for_co(data_train11,data_test11,len(data_train11),len(data_test11))
...
RFclassifier_for_co(data_train12,data_test12,len(data_train12),len(data_test12))
...
RFclassifier_for_co(data_train13,data_test13,len(data_train13),len(data_test13))
...
RFclassifier_for_co(data_train14,data_test14,len(data_train14),len(data_test14))
...
RFclassifier_for_co(data_train15,data_test15,len(data_train15),len(data_test15))
...
RFclassifier_for_co(data_train16,data_test16,len(data_train16),len(data_test16))
...
def RFclassifier_for_no2(data_train,data_test,train_rows,test_rows):
 Data_train = data_train.drop(0,axis=1)
 Data_train1 = Data_train.drop(1,axis=1)
 Target_train = Data_train[1]
 Data_test = data_test.drop(0,axis=1)
...
RFclassifier_for_no2(data_train1,data_test1,len(data_train1),len(data_test1))
...
RFclassifier_for_no2(data_train2,data_test2,len(data_train2),len(data_test2))
...
RFclassifier_for_no2(data_train3,data_test3,len(data_train3),len(data_test3))
...
RFclassifier_for_no2(data_train4,data_test4,len(data_train4),len(data_test4))
...
RFclassifier_for_no2(data_train6,data_test6,len(data_train6),len(data_test6))
...
RFclassifier_for_no2(data_train7,data_test7,len(data_train7),len(data_test7))
...
RFclassifier_for_no2(data_train8,data_test8,len(data_train8),len(data_test8))
...
RFclassifier_for_no2(data_train9,data_test9,len(data_train9),len(data_test9))
...
RFclassifier_for_no2(data_train10,data_test10,len(data_train10),len(data_test10))
...
def RFclassifier_for_o3(data_train,data_test,train_rows,test_rows):
 Data_train = data_train.drop(0,axis=1)
 Data_train1 = Data_train.drop(1,axis=1)
 Target_train = Data_train[1]
 Data_test = data_test.drop(0,axis=1)
...
RFclassifier_for_o3(data_train1,data_test1,len(data_train1),len(data_test1))
...
RFclassifier_for_o3(data_train2,data_test2,len(data_train2),len(data_test2))
...
RFclassifier_for_o3(data_train3,data_test3,len(data_train3),len(data_test3))
...
RFclassifier_for_o3(data_train4,data_test4,len(data_train4),len(data_test4))
...
RFclassifier_for_o3(data_train5,data_test5,len(data_train5),len(data_test5))
...
RFclassifier_for_o3(data_train6,data_test6,len(data_train6),len(data_test6))
...
RFclassifier_for_o3(data_train7,data_test7,len(data_train7),len(data_test7))
...
RFclassifier_for_o3(data_train8,data_test8,len(data_train8),len(data_test8))
...
RFclassifier_for_o3(data_train9,data_test9,len(data_train9),len(data_test9))
...
RFclassifier_for_o3(data_train10,data_test10,len(data_train10),len(data_test10))
...
RFclassifier_for_o3(data_train11,data_test11,len(data_train11),len(data_test11))
...
RFclassifier_for_o3(data_train12,data_test12,len(data_train12),len(data_test12))
...
RFclassifier_for_o3(data_train13,data_test13,len(data_train13),len(data_test13))
...
RFclassifier_for_o3(data_train14,data_test14,len(data_train14),len(data_test14))
...
RFclassifier_for_o3(data_train15,data_test15,len(data_train15),len(data_test15))
...
RFclassifier_for_o3(data_train16,data_test16,len(data_train16),len(data_test16))
